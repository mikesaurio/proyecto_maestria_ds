...
st.title("🎬 Análisis de Éxito y Recaudación de Películas — TMDb")
...
tab1, tab2, tab3 = st.tabs(["Películas", "Créditos", "Data"])
...
st.title("📊 Comparativa de Modelos de Clasificación")
...
st.title("🎬 Evaluador de Modelos de Éxito y Recaudación")
# === Seleccionar técnica ===
